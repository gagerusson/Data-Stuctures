...
//Pizza diameters
int const SMALL_DIAMETER = 14;
int const MEDIUM_DIAMETER = 18;
int const LARGE_DIAMETER = 24;
//Pizza costs
double const SMALL_COST = 8.39;
double const MEDIUM_COST = 13.25;
double const LARGE_COST = 15.78;
